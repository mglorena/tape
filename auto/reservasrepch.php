...
function LoadReservas($chId,$mes, $anio,$estado) {

    $reservaSearch = new Reserva();
    $ch = new Chofer();
    $reservas = $reservaSearch->ReporteChofer($chId,$mes, $anio, $estado);
    $response = array("1" => $reservas, "2" => $ch->GetAll());
    return $response;
}
?>
...
<?php
echo '<script type="text/javascript" src="reservasrepch.js?' . Conf::VERSION . '"></script>';
?>
<div id="content">
